...
## Materiales del Curso {#sec-MaterialCurso}
...
||[Striplog.ipynb](files/Striplog_ipynb.zip)| Archivo de Jupyter Notebook creado durante el Paso 2 |
||[Striplog.py](files/Striplog_py.zip)| Archivo de Python creado a partir del Jupyter Notebook|
...
1. Descarga GitHub Desktop (ver @sec-MaterialCurso).
...
1. Descarga Git (ver @sec-MaterialCurso).
...
1. Descarga Python 3.10 (ver @sec-MaterialCurso).
...
1. Descarga Visual Studio Code (ver @sec-MaterialCurso).
...
::: {.callout-important}
Todo el código siguiente que usa plt necesita estar en la misma celda. Aquí estará separado para su explicación.
:::
