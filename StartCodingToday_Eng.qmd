...
include-in-header:
  text: |
    ...
    .footer {
      ...
      text-align: center;
      padding: 10px;
      background-color: #7F7F7F; /* Dark grey background */
      color: #FFFFFF; /* White text */
    }
    </style>
include-after-body:
  text: |
    <footer class="footer">Copyright © Consulting (Chile) S.A. 2024. All Rights reserved.
    </footer>
---
...
## Course Overview {#sec-CourseOverview}
...
|-|-|-|
|**Step 1**|[GitHub Desktop](https://desktop.github.com/)| GitHub standalone executive file|
||[Git](https://git-scm.com/downloads)| Git standalone executive file|
|**Step 2**|[Python 3.10](files/python-3.10.11-amd64.exe)| Python 3.10 executive file|
||[VSCode](https://code.visualstudio.com/download)|Visual Code Basic standalone executive file |
|**Step 3**|[collar.csv](files/collar.csv)| Dataset for testing                         |
|| [merged_data.csv](files/merged_data.csv)|                                             |
||[Striplog.ipynb](files/Striplog_ipynb.zip)| Jupyter Notebook file created during Step 2 |
||[Striplog.py](files/Striplog_py.zip)| Python file created from the Jupyter Notebook|
|**Step 4**|[Striplog_OneCode.zip](files/Striplog_Onecode.zip)| OneCode folder tree
...
1. Download GitHub Desktop (see @sec-CourseMaterials)
...
1. Download Git (see @sec-CourseMaterials)
...
1. Download Python 3.10 (see @sec-CourseMaterials)
...
1. Download Visual Studio code (see @sec-CourseMaterials)
...
::: {.callout-note}
Streamlit is python library that allows to run data scripts into shareable web apps. Inconvenient is that the script needs to be shaped for streamlit app from the beginning, and visualisation setting can be tricky.
